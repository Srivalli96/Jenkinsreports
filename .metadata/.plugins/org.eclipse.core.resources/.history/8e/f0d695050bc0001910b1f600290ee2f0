...
public class OnlineShoppingTest {
	...
	ExtentTest logger;
	 ...
	 @AfterTest
	  public void endreportAfterTest() {
		 logger=extent.createTest("Closing of the report");
		 extent.flush();
	 ...
	 @AfterMethod
	  public void getResultAfterMethod(ITestResult result) throws IOException{
		 if(result.getStatus()==ITestResult.FAILURE) {
			  ...
			  FileUtils.copyFile(src,new File("C:\\Users\\training_h2a.06.15\\Desktop\\sravya\\s1.jpg"));
		 ...
		 /* TakesScreenshot sht=(TakesScreenshot)driver;
		  ...
		  logger.addScreenCaptureFromPath("C:\\Users\\training_h2a.06.15\\Desktop\\sravya\\s1.jpg",result.getName());
  ...
  public void testPayment() {
	  ...
	  driver.findElement(By .name("transpwd")).sendKeys("Trans@4567");
